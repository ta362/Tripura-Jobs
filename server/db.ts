...
const INITIAL_JOBS_RAW: Omit<JobRecord, 'content_hash'>[] = [
  ...
  {
    id: 'job-exam-admit-tcs-01',
    source_id: 'src-tpsc-01',
    organization_name: 'Tripura Public Service Commission (TPSC)',
    department_name: 'General Administration Department',
    job_title: 'Tripura Civil Service (TCS) Prelims Exam Schedule & e-Admit Card Notice',
    advertisement_number: 'Notif. No. 05/2026/Exam',
    notification_number: 'F.11(4)-GA(P&AR)/2026/EXAM',
    notification_date: '2026-09-10',
    application_start_date: '2026-09-10',
    application_last_date: '2026-11-15',
    exam_date: '2026-11-15',
    vacancy_count: null,
    qualification: 'Registered applicants for TCS/TPS Grade-II Advt 05/2026.',
    age_min: null,
    age_max: null,
    age_relaxation: 'As per TCS rules',
    salary: 'Official Exam Notice',
    pay_level: 'Exam Notice',
    job_location: 'Agartala Examination Centers',
    employment_type: 'Official Exam Notice',
    selection_process: 'Preliminary Examination in two shifts (General Studies & Aptitude). e-Admit cards available for download.',
    application_fee: 'Nil',
    category_information: 'All registered candidates',
    experience_required: 'None',
    important_dates: 'Admit Card download starts 25 Oct 2026. Examination Date: 15 Nov 2026.',
    official_notification_url: 'https://tpsc.tripura.gov.in/notifications/tcs_prelims_exam_schedule_2026.pdf',
    official_apply_url: 'https://tpsc.tripura.gov.in/online-application',
    source_url: 'https://tpsc.tripura.gov.in',
    notification_pdf_url: 'https://tpsc.tripura.gov.in/notifications/tcs_prelims_exam_schedule_2026.pdf',
    extracted_text: 'Official notification announcing exact timing, shift details, and e-admit card download link for Tripura Civil Service Preliminary Examination 2026.',
    summary: 'Official TPSC notice regarding TCS/TPS Grade-II Preliminary Examination schedule and instructions for downloading e-admit cards.',
    eligibility_summary: 'For successfully registered applicants of Advt No 05/2026.',
    status: 'ACTIVE',
    is_new: true,
    is_updated: false,
    is_expired: false,
    ...
    last_seen_at: new Date().toISOString(),
    last_updated_at: new Date(Date.now() - 86400000 * 1).toISOString(),
    created_at: new Date(Date.now() - 86400000 * 1).toISOString(),
  },
  {
    id: 'job-exam-jrbt-schedule-02',
    source_id: 'src-jrbt-03',
    organization_name: 'Joint Recruitment Board, Tripura (JRBT)',
    department_name: 'Directorate of Employment Services',
    job_title: 'JRBT Group-C & D Written Examination Date & Roll Number Notice',
    advertisement_number: 'JRBT/RECT/EXAM/2026/02',
    notification_number: 'No.F.1(2)/DESMP/JRBT/EXAM/2026',
    notification_date: '2026-09-09',
    application_start_date: '2026-09-09',
    application_last_date: '2026-10-25',
    exam_date: '2026-10-25',
    vacancy_count: null,
    qualification: 'All candidates who applied for Group-C (LDC) and Group-D posts under JRBT.',
    age_min: null,
    age_max: null,
    age_relaxation: 'As per JRBT guidelines',
    salary: 'Official Exam Schedule Notice',
    pay_level: 'Exam Notice',
    job_location: 'District Headquarters across Tripura',
    employment_type: 'Official Exam Schedule',
    selection_process: 'Written Examination schedule notification with venue allocation details.',
    application_fee: 'Nil',
    category_information: 'All registered applicants',
    experience_required: 'None',
    important_dates: 'Exam Date: 25 October 2026 (Sunday). Shift 1: 10:00 AM to 12:00 PM.',
    official_notification_url: 'https://employment.tripura.gov.in/jrbt_written_exam_schedule_2026.pdf',
    official_apply_url: 'https://employment.tripura.gov.in',
    source_url: 'https://employment.tripura.gov.in',
    notification_pdf_url: 'https://employment.tripura.gov.in/jrbt_written_exam_schedule_2026.pdf',
    extracted_text: 'Joint Recruitment Board Tripura notifies the date, timing and guidelines for written examination of Group-C and Group-D posts.',
    summary: 'Official examination schedule and guidelines published by JRBT for Group-C and Group-D written tests.',
    eligibility_summary: 'Registered candidates of JRBT recruitment.',
    status: 'ACTIVE',
    is_new: true,
    is_updated: false,
    is_expired: false,
